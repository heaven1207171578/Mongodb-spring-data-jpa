package com.bucom.service;

import com.bucom.model.Friend;
import com.bucom.repoistory.UserReporistory;
...
public class IUserService {
  ...
  @Autowired private UserReporistory userReporistory;

  public int addFriend(String userId, String friendId) {
    Friend find = userReporistory.findByUseridAndFriendid(userId, friendId);
