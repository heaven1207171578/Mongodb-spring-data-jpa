  ...
  public static void main(String[] args) {
    Claims heavenY =
        Jwts.parser()
            ...
            .parseClaimsJws(
                "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI5OTkiLCJzdWIiOiLoi40iLCJpYXQiOjE1NDU5ODg3MzAsImV4cCI6MTU0NTk4OTg2MCwicm9sZSI6ImFkbWluIn0.OsOBBM_ohu5EZjZquolgT9lnq3Ua62Q4wjCueDqMh7Y")
            .getBody();
