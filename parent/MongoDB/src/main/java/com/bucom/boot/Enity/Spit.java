...
public class Spit {
  ...
  public boolean equals(final Object o) {
    ...
    if (this$publishtime == null
        ? other$publishtime != null
        : !this$publishtime.equals(other$publishtime)) return false;
    ...
    if (this$visits == null ? other$visits != null : !this$visits.equals(other$visits))
      return false;
    final Object this$thumbup = this.getThumbup();
    final Object other$thumbup = other.getThumbup();
    if (this$thumbup == null ? other$thumbup != null : !this$thumbup.equals(other$thumbup))
      return false;
